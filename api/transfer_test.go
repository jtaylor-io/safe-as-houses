...
func TestCreateTransferAPI(t *testing.T) {
	...
	account1 := randomAccountWithCurrency(user1.Username, util.USD)
	account2 := randomAccountWithCurrency(user2.Username, util.USD)
	account3 := randomAccountWithCurrency(user3.Username, util.HKD)
